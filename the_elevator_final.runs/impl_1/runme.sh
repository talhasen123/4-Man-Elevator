...
HD_PWD='C:/Users/USER/the_elevator_final/the_elevator_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log elevatorFiniteStateMachine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source elevatorFiniteStateMachine.tcl -notrace

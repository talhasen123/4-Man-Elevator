...
HD_PWD='C:/Users/USER/the_elevator_final/the_elevator_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elevatorFiniteStateMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elevatorFiniteStateMachine.tcl
